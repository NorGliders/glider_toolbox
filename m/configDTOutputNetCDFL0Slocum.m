...
%     '_FillValue'    default_fill_value };
  ...
  global_atts = ...
  {
    ...
    'date_update'                  'undefined'  % EGO format added
    'deployment_code'              'undefined'  % EGO format added
    'deployment_label'             'undefined'  % EGO format added
    ...
    'ices_platform_code'           'undefined'  % EGO format added
    'id'                           'undefined'  % EGO format added
    ...
    'platform_code'                '99999'  % EGO format added
    ...
    'quality_index'                'unknown quality'  % EGO format added
    'qc_manual'                    'none'             % EGO format added
    'sdn_edmo_code'                '3410'             % EGO format added
    'source'                       'Glider observation'  % EGO format changed
