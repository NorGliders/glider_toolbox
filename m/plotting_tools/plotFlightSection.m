...
%
%  Syntax:
%    PLOTFLIGHTSECTION(OPTIONS)
%    PLOTFLIGHTSECTION(OPT1, VAL1, ...)
%    PLOTFLIGHTSECTION(H, OPTIONS)
%    PLOTFLIGHTSECTION(H, OPT1, VAL1, ...)
%    [HFIG, HAXS, HCBA, HSCT] = PLOTFLIGHTSECTION(...)
%
%  Description:
%    PLOTFLIGHTSECTION(OPTIONS) and 
%    PLOTFLIGHTSECTION(OPT1, VAL1, ...) generate a new figure with a
...
%        Default value: struct()
%  
%    PLOTFLIGHTSECTION(H, ...) does not create a new figure,
%    but plots  to figure given by figure handle H.
%
%    [HFIG, HAXS, HCBA, HSCT] = PLOTFLIGHTSECTION(...) returns
...
%  along with this program.  If not, see <http://www.gnu.org/licenses/>.
  ...
  elseif mod(numel(args), 2) == 0
    ...
    error('glider_toolbox:PLOTFLIGHTSECTION:InvalidOptions', ...
  ...
  for opt_idx = 1:numel(option_key_list)
    ...
    if isfield(options, opt)
      ...
      error('glider_toolbox:PLOTFLIGHTSECTION:InvalidOption', ...
